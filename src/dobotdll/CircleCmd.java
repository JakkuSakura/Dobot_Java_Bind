 ...
 */
public class CircleCmd extends Structure {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("field1", "field2", "count");
	}
	/**
	 * @param field1 C type : field1_struct<br>
	 * @param field2 C type : field2_struct
	 */
	public CircleCmd(field1_struct field1, field2_struct field2, int count) {
		super();
		this.field1 = field1;
		this.field2 = field2;
		this.count = count;
	}
	public CircleCmd(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends CircleCmd implements Structure.ByReference {
		
	};
	public static class ByValue extends CircleCmd implements Structure.ByValue {
